...
\Gls{rv} has not only the goal to detect errors but also to react when one is detected.
...
% Timing model, maybe somehow harness Vector clocks -> would  compplicate instrumentation! Also would need support in TeSSLa language.
