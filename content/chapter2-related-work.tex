...
A front-end is responsible for translating a source language, e.g. C or C++ into \gls{llvm} \gls{ir}, a strongly typed \gls{risc} instruction set which is independent from the target platform.
The middle-end is performing source-to-source transformations on the \gls{ir}, e.g. to perform analizations or optimizations.
