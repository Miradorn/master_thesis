...
Timing functions complicate the reasoning about schedules and causality and therefore are not included in \Cref{sec:behaviours:without_timing}.
...
The other way, which is used in this thesis, does not alter the input queues:
