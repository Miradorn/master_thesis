...
\begin{proof}
  ...
  No matter if the States differ in their input or output Events, theese Events would have to be part of Transitions, because States are only updated by Transitions.
  Because both Runs have the same Transitions, no Transition including this extra Event can exist, therefore there can't be two Nodes with different States.
\end{proof}
